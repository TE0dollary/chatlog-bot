...
// initContactCache initializes the contact cache.
func (r *Repository) initContactCache(ctx context.Context) error {
	...
	for _, contact := range contacts {
		...
		// non-friend contacts go into the chatroom-user index
		if !contact.IsFriend {
...
// getFullContact looks up a contact by username, including chatroom members.
